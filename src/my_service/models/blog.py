# src/my_service/models/blog.py

from datetime import datetime, timezone
from typing import List, Optional

from sqlalchemy import DDL, Column, ColumnElement, DateTime, Index, Text
...
def compile_tsvector_sqlite(element, compiler, **kw):
    # вместо настоящего TSVECTOR для SQLite будет просто TEXT
    return "TEXT"
@compiles(DDL, "sqlite")
def _ignore_ddl_on_sqlite(element, compiler, **kw):
    return ""
...
# Определение DDL-триггера, но без event.listen
